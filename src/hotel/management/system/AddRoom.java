...
public class AddRoom extends JFrame implements ActionListener {
    ...
    public AddRoom() {
        ...
        comboBox = new JComboBox<String>(new String[]{"Available", "Occupied"});
        ...
        comboBox_2 = new JComboBox<String>(new String[]{"Cleaned", "Dirty"});
        ...
        comboBox_3 = new JComboBox<String>(new String[]{"Single Bed", "Double Bed"});
        ...
        try {
            ...
            if (ae.getSource() == b1) {
                try {
                    ...
                    String check = "select * from room where roomnumber = " + room;
                    if (c.s.executeQuery(check).next()) {
